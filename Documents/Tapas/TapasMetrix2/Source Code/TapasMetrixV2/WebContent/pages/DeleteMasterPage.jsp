...
<body>
	...
	<a id="showhidetrigger" href="#" style="text-decoration:none; text-align: right; color: black"><label for="addNewUser">Delete user</label></a>
    
    <br>
    <a id="showhidetrigger1" href="#" style="text-decoration:none; text-align: left; color: black"><label for="addNewUser">Delete product</label></a>

	<br>
    <a id="showhidetrigger2" href="#" style="text-decoration:none; text-align: right; color: black"><label for="addNewUser">Delete activity</label></a>
