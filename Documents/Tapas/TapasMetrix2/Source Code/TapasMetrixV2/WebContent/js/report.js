...
currentReportName="";
	...
	function generateReport(reportName) {
		...
		var reporturl ="/Customizzation_Metrix/loadReport?ReportName="+reportName+"&ReportFormat=html";
		
		$("#reportData").html("Loading...<br><img src='/Customizzation_Metrix/images/loading.gif' align='middle' >");
